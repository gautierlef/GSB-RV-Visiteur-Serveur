...
CREATE TABLE Motif (
	...
	mot_libelle varchar(20) NOT NULL,
...
CREATE TABLE RapportVisite (
  ...
  mot_code varchar(20) NOT NULL,
  pra_num int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (vis_matricule,rap_num, pra_num)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO RapportVisite VALUES
	( 'a131' , 1 , '2018-03-01' , 'RAS' , '2018-03-02', 1, 'M3', 22) ,
	( 'a131' , 2 , '2018-04-02' , 'RAS' , '2018-04-03', 2, 'M1', 22) ,
	( 'a131' , 3 , '2018-04-03' , 'RAS' , '2018-04-03', 3, 'M2', 18) ,
	( 'a131' , 4 , '2018-05-10' , 'RAS' , '2018-05-13', 4, 'M1', 22) ,
	( 'a131' , 5 , '2018-05-21' , 'RAS' , '2018-02-22', 5, 'M1', 18) ;
